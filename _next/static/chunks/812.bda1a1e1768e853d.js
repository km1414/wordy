...
const functions = {
    ...
    loadContract: async (args)=>{
        const { WordyContract  } = await __webpack_require__.e(/* import() */ 539).then(__webpack_require__.bind(__webpack_require__, 8539));
    ...
    createGuessTransaction: async (args)=>{
        state.transaction = await snarkyjs__WEBPACK_IMPORTED_MODULE_0__/* .Mina.transaction */ .No.transaction(()=>{
            state.zkapp.guessWithoutTokenTransactions(snarkyjs__WEBPACK_IMPORTED_MODULE_0__/* .CircuitString.fromString */ ._G.fromString(args.word));
        });
    },
...
/******/ 			return "static/chunks/" + (chunkId === 829 ? "cc8f0cfa" : chunkId) + "." + {"539":"0a5c6c93332640db","829":"caf3e7f07facfd12"}[chunkId] + ".js";
/******/ 		};
/******/ 	}();
/******/ 	
...
/******/ 	!function() {
/******/ 		__webpack_require__.p = "/wordy//_next/";
/******/ 	}();
/******/ 	
